            ...
            >
                <View style={{zIndex: -1, position: "relative", justifyContent: "center", display:'flex', alignItems: "center", padding: 30, flex: 1}}>
                    ...
                    <View style={{zIndex:4, position: 'absolute', alignSelf: 'center', width: 600, height: 450, flex: 1}}>
                        <ButtonBuilding id={0} onBuilding={(id) => onBuilding(id)} color={customColors.green} selected={destination[1] == -1} coords={[420, 65]}>L1</ButtonBuilding>
                        <ButtonBuilding id={1} onBuilding={(id) => onBuilding(id)} color={customColors.yellow} selected={destination[1] == -1} coords={[290, 170]}>L2</ButtonBuilding>
                        ...
                        <ButtonBuilding id={3} onBuilding={(id) => onBuilding(id)} color={customColors.purple} selected={destination[1] == -1} coords={[485, 178]}>L4</ButtonBuilding>
                        <ButtonBuilding id={4} onBuilding={(id) => onBuilding(id)} color={customColors.orange} selected={destination[1] == -1} coords={[140, 250]}>IQL</ButtonBuilding>
                    </View>
                    {destination[1] == -1 ?
                        <>
