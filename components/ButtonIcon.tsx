...
export default function ButtonIcon({color, imageSource, action, size, buttonPadding }) {
    ...
    return (
        <Pressable
            style={ ({ pressed }) => [styles.iconButtonBasics, {backgroundColor: !pressed ? color : colorPressed, padding: buttonPadding}] } onPress={action}>
